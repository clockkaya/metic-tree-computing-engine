...
import static com.sama.api.ledger.bean.indicator.MetricComprehensiveProtectionConstants.III_RATE_ATTACK_AVERAGE_DETECTION_HW;

/**
 * @author: huxh
 * @description: HW/专项对抗防护场景|攻击节点平均检测率
 * @datetime: 2025/7/29 15:58
 */
@Component
public class RateAttackAverageDetectionHwCalculator extends ComprehensiveProtectionProxyCalculator<ComprehensiveProtectionPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = III_RATE_ATTACK_AVERAGE_DETECTION_HW;
    }
