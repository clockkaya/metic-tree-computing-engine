...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_MICRO_SEGMENTATION;
 ...
 */
@Component
public class AbilityMicroSegmentationCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_MICRO_SEGMENTATION;
    }
