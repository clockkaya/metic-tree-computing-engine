...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_LOG_AUDIT;
 ...
 */
@Component
public class AbilityLogAuditCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_LOG_AUDIT;
    }
