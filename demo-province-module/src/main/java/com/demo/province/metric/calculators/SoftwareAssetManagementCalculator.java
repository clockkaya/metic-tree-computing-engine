...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_ASSET_MANAGEMENT;
 ...
 */
@Component
public class SoftwareAssetManagementCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_ASSET_MANAGEMENT;
    }
