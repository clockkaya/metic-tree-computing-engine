...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_DATA_ASSET_MANAGEMENT;
 ...
 */
@Component
public class SoftwareDataAssetManagementCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_DATA_ASSET_MANAGEMENT;
    }
