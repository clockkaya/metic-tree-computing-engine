 ...
 * @author: huxh
 * @description:
 * @datetime: 2025/7/21 14:14
 */
public class BenefitInternalConstructionOnlineBO extends BenefitInternalConstructionDO {
    ...
    public String toString() {
        return "BenefitInternalConstructionOnlineBO{" +
            "current=" + current +
            ", size=" + size +
            ", infoId='" + infoId + '\'' +
            ", locks=" + locks +
