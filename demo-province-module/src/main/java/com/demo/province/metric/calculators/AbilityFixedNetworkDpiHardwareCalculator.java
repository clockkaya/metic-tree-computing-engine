...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_FIXED_NETWORK_DPI_HARDWARE;
 ...
 */
@Component
public class AbilityFixedNetworkDpiHardwareCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_FIXED_NETWORK_DPI_HARDWARE;
    }
