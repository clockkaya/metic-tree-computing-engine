...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_MOBILE_INTERNET_LOG_RETENTION_CUSTOMIZED;
 ...
 * @author: huxh
 * @description:
 * @datetime: 2025/9/5 15:01
 */
@Component
public class SoftwareMobileInternetLogRetentionCustomized extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_MOBILE_INTERNET_LOG_RETENTION_CUSTOMIZED;
    }
