...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_MOBILE_INTERNET_LOG_RETENTION_CENTRALIZED;
 ...
 * @author: huxh
 * @description:
 * @datetime: 2025/9/5 14:05
 */
@Component
public class SoftwareMobileInternetLogRetentionCentralizedCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_MOBILE_INTERNET_LOG_RETENTION_CENTRALIZED;
    }
