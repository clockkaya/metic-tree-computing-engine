...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_WEB_DYNAMIC_DEFENSE_HARDWARE;
 ...
 */
@Component
public class AbilityWebDynamicDefenseHardwareCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_WEB_DYNAMIC_DEFENSE_HARDWARE;
    }
