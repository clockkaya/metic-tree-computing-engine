...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_UEBA_CORE;
 ...
 */
@Component
public class SoftwareUebaCoreCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_UEBA_CORE;
    }
