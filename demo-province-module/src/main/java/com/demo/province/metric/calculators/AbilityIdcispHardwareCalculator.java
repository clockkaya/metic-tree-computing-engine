...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_IDCISP_HARDWARE;
 ...
 */
@Component
public class AbilityIdcispHardwareCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_IDCISP_HARDWARE;
    }
