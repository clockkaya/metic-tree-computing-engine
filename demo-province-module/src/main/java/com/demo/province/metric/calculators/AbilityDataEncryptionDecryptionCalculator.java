...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_DATA_ENCRYPTION_DECRYPTION;
 ...
 */
@Component
public class AbilityDataEncryptionDecryptionCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_DATA_ENCRYPTION_DECRYPTION;
    }
