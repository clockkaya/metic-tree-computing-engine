...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_BASTION_HOST;
 ...
 */
@Component
public class AbilityBastionHostCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_BASTION_HOST;
    }
