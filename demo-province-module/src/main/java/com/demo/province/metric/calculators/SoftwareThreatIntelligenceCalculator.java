...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_THREAT_INTELLIGENCE;
 ...
 */
@Component
public class SoftwareThreatIntelligenceCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_THREAT_INTELLIGENCE;
    }
