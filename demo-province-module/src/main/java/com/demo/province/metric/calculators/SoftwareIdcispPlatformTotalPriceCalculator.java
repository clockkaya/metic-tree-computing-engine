...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_IDCISP_PLATFORM_TOTAL_PRICE;
 ...
 */
@Component
public class SoftwareIdcispPlatformTotalPriceCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_IDCISP_PLATFORM_TOTAL_PRICE;
    }
