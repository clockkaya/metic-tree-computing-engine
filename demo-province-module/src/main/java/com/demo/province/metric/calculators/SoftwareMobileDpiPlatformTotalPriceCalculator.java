...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_MOBILE_DPI_PLATFORM_TOTAL_PRICE;
 ...
 */
@Component
public class SoftwareMobileDpiPlatformTotalPriceCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_MOBILE_DPI_PLATFORM_TOTAL_PRICE;
    }
