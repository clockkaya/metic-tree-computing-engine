...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_DATA_SECURITY_SITUATIONAL_AWARENESS;
 ...
 */
@Component
public class SoftwareDataSecuritySituationalAwarenessCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_DATA_SECURITY_SITUATIONAL_AWARENESS;
    }
