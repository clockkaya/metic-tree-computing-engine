...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_NETWORK_DLP;
 ...
 */
@Component
public class AbilityNetworkDlpCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_NETWORK_DLP;
    }
