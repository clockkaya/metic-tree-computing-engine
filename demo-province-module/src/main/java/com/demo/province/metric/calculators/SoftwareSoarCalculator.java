...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_SOAR;
 ...
 */
@Component
public class SoftwareSoarCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_SOAR;
    }
