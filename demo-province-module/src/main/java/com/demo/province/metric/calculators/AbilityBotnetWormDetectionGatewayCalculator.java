...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_BOTNET_WORM_DETECTION_GATEWAY;
 ...
 */
@Component
public class AbilityBotnetWormDetectionGatewayCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_BOTNET_WORM_DETECTION_GATEWAY;
    }
