 ...
 * 指标结果统计的省侧副本
 * @author: huxh
 * @description: 存储从集团侧同步回来的汇总结果。这张表的数据完全依赖集团侧，本地只读不改。
 * @datetime: 2025/9/9 13:28
 */
@TableName("sama_ledger.group_statistic_bak")
public class GroupStatisticBakDO extends BaseModel {
