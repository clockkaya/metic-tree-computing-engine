...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_DYNAMIC_DATA_MASKING;
 ...
 */
@Component
public class AbilityDynamicDataMaskingCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_DYNAMIC_DATA_MASKING;
    }
