...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_IDCISP_SOFTWARE;
 ...
 */
@Component
public class AbilityIdcispSoftwareCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_IDCISP_SOFTWARE;
    }
