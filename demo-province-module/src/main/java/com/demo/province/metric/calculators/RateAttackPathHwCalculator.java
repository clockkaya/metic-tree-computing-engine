...
import static com.sama.api.ledger.bean.indicator.MetricComprehensiveProtectionConstants.III_RATE_ATTACK_PATH_HW;

/**
 * @author: huxh
 * @description: HW/专项对抗防护场景|攻击路径检测率
 * @datetime: 2025/7/23 14:08
 */
@Component
public class RateAttackPathHwCalculator extends ComprehensiveProtectionProxyCalculator<ComprehensiveProtectionPreparedDataBO> {

    private static final Logger logger = LogManager.getLogger(RateAttackPathHwCalculator.class);

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = III_RATE_ATTACK_PATH_HW;
    }
