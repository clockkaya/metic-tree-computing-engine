...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_NETWORK_ATTACK_TRACING;
 ...
 */
@Component
public class SoftwareNetworkAttackTracingCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_NETWORK_ATTACK_TRACING;
    }
