...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_HONEYPOT;
 ...
 */
@Component
public class AbilityHoneypotCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_HONEYPOT;
    }
