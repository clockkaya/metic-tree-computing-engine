...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_WAF_ATOMIC_CAPABILITY;
 ...
 */
@Component
public class AbilityWafAtomicCapabilityCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_WAF_ATOMIC_CAPABILITY;
    }
