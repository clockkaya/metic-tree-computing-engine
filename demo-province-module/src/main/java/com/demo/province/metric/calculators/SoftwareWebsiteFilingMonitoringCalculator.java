...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_WEBSITE_FILING_MONITORING;
 ...
 */
@Component
public class SoftwareWebsiteFilingMonitoringCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_WEBSITE_FILING_MONITORING;
    }
