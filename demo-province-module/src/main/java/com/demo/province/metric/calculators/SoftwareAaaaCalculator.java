...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_AAAA;
 ...
 */
@Component
public class SoftwareAaaaCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_AAAA;
    }
