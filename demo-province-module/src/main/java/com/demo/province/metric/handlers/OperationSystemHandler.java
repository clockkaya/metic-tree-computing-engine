...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.IV_OPERATION_SYSTEM;
 ...
 */
@Component
public class OperationSystemHandler extends BenefitProxyHandler<BenefitPreparedDataBO> {

    @Override
    protected void assignHandlerKey() {
        handlerKey = IV_OPERATION_SYSTEM;
    }
