...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_MOBILE_DPI_SOFTWARE;
 ...
 */
@Component
public class AbilityMobileDpiSoftwareCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_MOBILE_DPI_SOFTWARE;
    }
