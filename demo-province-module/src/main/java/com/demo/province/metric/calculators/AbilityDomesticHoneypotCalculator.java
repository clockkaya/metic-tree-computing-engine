...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_DOMESTIC_HONEYPOT;
 ...
 */
@Component
public class AbilityDomesticHoneypotCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_DOMESTIC_HONEYPOT;
    }
