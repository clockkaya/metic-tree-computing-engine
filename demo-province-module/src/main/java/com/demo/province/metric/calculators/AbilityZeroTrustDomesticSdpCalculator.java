...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_ZERO_TRUST_DOMESTIC_SDP;
 ...
 */
@Component
public class AbilityZeroTrustDomesticSdpCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_ZERO_TRUST_DOMESTIC_SDP;
    }
