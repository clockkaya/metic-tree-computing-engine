...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_ABNORMAL_TRAFFIC_DETECTION_FORWARDING_DEVICE;
 ...
 */
@Component
public class AbilityAbnormalTrafficDetectionForwardingDeviceCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_ABNORMAL_TRAFFIC_DETECTION_FORWARDING_DEVICE;
    }
