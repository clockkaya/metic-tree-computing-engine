...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_FIXED_NETWORK_DPI_PLATFORM_TOTAL_PRICE;
 ...
 */
@Component
public class SoftwareFixedNetworkDpiPlatformTotalPriceCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_FIXED_NETWORK_DPI_PLATFORM_TOTAL_PRICE;
    }
