...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_INTERNET_EXPOSURE_MANAGEMENT;
 ...
 */
@Component
public class SoftwareInternetExposureManagementCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_INTERNET_EXPOSURE_MANAGEMENT;
    }
