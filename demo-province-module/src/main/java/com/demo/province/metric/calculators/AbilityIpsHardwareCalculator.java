...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_IPS_HARDWARE;
 ...
 */
@Component
public class AbilityIpsHardwareCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_IPS_HARDWARE;
    }
