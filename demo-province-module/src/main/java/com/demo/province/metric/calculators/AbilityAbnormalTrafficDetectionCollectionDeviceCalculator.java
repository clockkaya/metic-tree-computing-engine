...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_ABNORMAL_TRAFFIC_DETECTION_COLLECTION_DEVICE;
 ...
 */
@Component
public class AbilityAbnormalTrafficDetectionCollectionDeviceCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_ABNORMAL_TRAFFIC_DETECTION_COLLECTION_DEVICE;
    }
