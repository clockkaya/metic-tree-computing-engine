...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_CONTAINER_SECURITY;
 ...
 */
@Component
public class AbilityContainerSecurityCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_CONTAINER_SECURITY;
    }
