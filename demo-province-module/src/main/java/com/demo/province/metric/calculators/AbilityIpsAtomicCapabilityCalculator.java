...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_IPS_ATOMIC_CAPABILITY;
 ...
 */
@Component
public class AbilityIpsAtomicCapabilityCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_IPS_ATOMIC_CAPABILITY;
    }
