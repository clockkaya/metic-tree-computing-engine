...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_WEB_DYNAMIC_DEFENSE_SOFTWARE;
 ...
 */
@Component
public class AbilityWebDynamicDefenseSoftwareCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_WEB_DYNAMIC_DEFENSE_SOFTWARE;
    }
