...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_FIREWALL_HARDWARE;
 ...
 */
@Component
public class AbilityFirewallHardwareCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_FIREWALL_HARDWARE;
    }
