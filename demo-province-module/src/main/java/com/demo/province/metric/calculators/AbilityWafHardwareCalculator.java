...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_WAF_HARDWARE;
 ...
 */
@Component
public class AbilityWafHardwareCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_WAF_HARDWARE;
    }
