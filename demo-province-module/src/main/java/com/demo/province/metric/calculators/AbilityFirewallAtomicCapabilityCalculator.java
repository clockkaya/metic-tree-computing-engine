...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_FIREWALL_ATOMIC_CAPABILITY;
 ...
 */
@Component
public class AbilityFirewallAtomicCapabilityCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_FIREWALL_ATOMIC_CAPABILITY;
    }
