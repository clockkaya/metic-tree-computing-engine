...
import static com.sama.api.ledger.bean.indicator.MetricBenefitConstants.V_PATCH_MANAGEMENT_CORE_NATIVE;
 ...
 */
@Component
public class SoftwarePatchManagementCoreNativeCalculator extends BenefitProxyCalculator<BenefitPreparedDataBO> {

    @Override
    protected void assignCalculatorKey() {
        calculatorKey = V_PATCH_MANAGEMENT_CORE_NATIVE;
    }
